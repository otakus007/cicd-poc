# Fargate — High-Level Infrastructure Overview
...
flowchart TB
    ...
    subgraph AWS["AWS Cloud (us-east-1)"]
        ...
        subgraph SharedInfra["Shared Resources"]
            ECSCluster[ECS Fargate Cluster - FARGATE + FARGATE_SPOT]
            IAMRoles[IAM Roles - Pipeline, CodeBuild, - ECS Exec, ECS Task, - Webhook Lambda]
        end
